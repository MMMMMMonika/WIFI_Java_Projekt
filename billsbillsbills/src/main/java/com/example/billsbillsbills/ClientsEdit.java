...
import logic.DBClientSelectionViewService;
...
public class ClientsEdit {
    ...
    public void initialize() throws SQLException {
        ...
        DBClientSelectionViewService<Client> clientDBReaderService = new DBClientSelectionViewService<>(clientResultToList);
