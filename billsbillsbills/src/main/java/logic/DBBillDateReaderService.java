...
public class DBBillDateReaderService<T> {
    private final ResultToList<T> resultToList;

    public DBBillDateReaderService(ResultToList<T> resultToList) {
        this.resultToList = resultToList;
    }

    public int readAmountOfBillDatesFromDB(DBConnection dbConnection) throws SQLException {
