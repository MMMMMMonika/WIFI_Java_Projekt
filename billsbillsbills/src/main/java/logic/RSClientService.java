...
public class RSClientService implements ResultToList{
    ...
    public List<Client> resultSetToList(ResultSet resultSet) throws SQLException {
        ...
        while (resultSet.next()) {
            ...
            clientList.add(new Client(clientID, clientNumber, companyName, contactName, address, postalCode, city, country, phoneNumber, eMail, vatNumber));
        }
        return clientList;
    }
}
